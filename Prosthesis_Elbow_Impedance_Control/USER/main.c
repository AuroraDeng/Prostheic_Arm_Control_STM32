...
{	
  ...
  {	  
			...
			uint8_t ZB_current_data[4] = {0x00};
...
//				   (data_ret[38] - last_pos >100 || data_ret[38] - last_pos < -100) )
			if ( RET_TRUE == detect_torque_outside(ZB_torque, THREHOLD_TORQUE) )
			{
					...
					while(!(
									(( last_pos - 500 ) < *(int32_t *)(&data_ret[38])) &&
								  (( last_pos + 500 ) > *(int32_t *)(&data_ret[38]))   ))
					{
							MotorData_CAN_Send(&ZB_torque);
...
//					if ( ZB_torque < 0 )
//					{
//						printf("/resistance insert/ |trigger on the touch!| ZB_torque < 0 ZB_torque*1000 = [%d]\r\n",int(ZB_torque*1000));
//						printf("/resistance insert/ |trigger on the touch!| ZB_torque < 0 data_ret[38]-last_pos = [%d]\r\n",data_ret[38]-last_pos);
//						//Motor_ZB(int(ZB_torque*(-1000)));vTaskDelay(200); 
//						//Motor_ZB(ZB_torque*1000+last_pos);
//						//Motor_ZB((data_ret[38]-last_pos) + 3);
//						//printf("/resistance insert/  ZB_torque > 0 (data_ret[38]-last_pos)=[%d]",(data_ret[38]-last_pos));
//						//Uint16 ReceiveCommand = ;
...
//						//Motor_ZB(ZB_torque*1000+last_pos);
//						//Motor_ZB((data_ret[38]-last_pos) - 3);
//						//printf("/resistance insert/ ZB_torque > 0  (data_ret[38]-last_pos)=[%f]",(data_ret[38]-last_pos));
//					}
					
			}
//			while(detect_torque_outside(ZB_torque, THREHOLD_TORQUE))
//			{	
//					printf("/resistance insert/ waitting ZB_torque =[%d]",ZB_torque);
//					MotorData_CAN_Send(&ZB_torque);
//			}
//			
...
//			printf("/resistance insert/\r\n");
//			printf("/resistance insert/\r\n");
//			printf("/resistance insert/\r\n");

//			printf("ZB_current_data[0] = %d,\r\n"
//					"ZB_current_data[1] = %d,\r\n"
//					"ZB_current_data[2] = %d,\r\n"
//					"ZB_current_data[3] = %d,\r\n",
//											ZB_current_data[0],
